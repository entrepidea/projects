...
import static com.entrepidea.core.basic.LongComputationTests.Pi.computePi;

/**
 * Created by jonat on 4/13/2017.
 * an example to demo long complex computations
 * See here: http://javahowto.blogspot.com/2011/08/example-of-expensive-computation.html
 */
public class LongComputationTests {


    static class Pi implements java.io.Serializable {
    ...
    public void testLongComputation(){
            BigDecimal result = computePi(50000);
