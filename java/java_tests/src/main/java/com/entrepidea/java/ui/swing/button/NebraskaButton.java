package com.entrepidea.java.ui.swing.button;
...
/**
 * This class shows how to draw a customized button, basically, paintComponent and paintBorder are 
 * to be overridden. see this link for details:
 * http://www.7128.com/articles/resourcesarticle061227.html
 * 
 * @date 10/29/12
 *  
 * */
...
//	    m_dHeightFill - dOffsetFill);
	...
	protected void paintBorder(Graphics g){
	    ...
	    g2.setStroke(
	      new BasicStroke(
	        BORDER_WIDTH, BasicStroke.CAP_BUTT, BasicStroke.JOIN_BEVEL)
	    );
	    g2.draw(m_areaDraw);
