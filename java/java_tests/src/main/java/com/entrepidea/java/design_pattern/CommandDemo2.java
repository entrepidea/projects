...
public class CommandDemo2 extends JPanel {
	...
	public CommandDemo2() {
		...
		// Create buttons
		btnUpload = new UploadButton(CommandDemo2.UPLOAD);
		btnUpload.setMnemonic(KeyEvent.VK_U);
		btnDownload = new DownloadButton(CommandDemo2.DOWNLOAD);
		btnDownload.setMnemonic(KeyEvent.VK_N);
		btnDelete = new DeleteButton(CommandDemo2.DELETE);
		btnDelete.setMnemonic(KeyEvent.VK_D);
		ExitButton btnExit = new ExitButton(CommandDemo2.EXIT);
		...
		try {
			...
			SwingUtilities.updateComponentTreeUI(CommandDemo2.this);
		} catch (Exception ex) {
	...
	private static void createAndShowUI() {
		...
		contentPane.add(new CommandDemo2());
