...
//Copyright MageLang Institute; Version $Id: FontFormatterEditor.java,v 1.1 2013-11-07 05:05:14 hai Exp $
import java.awt.*;
...
public class FontFormatterEditor extends JFrame {
  ...
  public FontFormatterEditor(String lab) {
    super (lab);
...
*/
  ...
  public static void main (String args[]) {
    FontFormatterEditor frame = new FontFormatterEditor("Mini Text Editor");
