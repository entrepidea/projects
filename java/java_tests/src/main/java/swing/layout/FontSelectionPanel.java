 ...
 * demonstrating its use: <a name="codeSample">
 * <p>
 * <!-- prefix each pre line with '*' to avoid javadoc whitespace bug -->
 * 
 * <pre>
 * import java.awt.*;
 ...
 * 				try {
 * 					JOptionPane.showMessageDialog(frame, &quot;Selected font is: &quot;
 * 							+ fontSelectionPanel.getSelectedFont(),
 * 							&quot;Selected Font&quot;, JOptionPane.INFORMATION_MESSAGE);
 * 				} catch (FontSelectionPanel.InvalidFontException ife) {
 * 					JOptionPane.showMessageDialog(frame,
 * 							&quot;You have not selected a valid font&quot;,
 * 							&quot;Invalid Font&quot;, JOptionPane.ERROR_MESSAGE);
 * 				}
 * 			}
 * 		});
 ...
 * <dl>
 * <dt><b>1.1</b> (August 19, 2000)
 * <dd><tt>protected</tt> access to all major components now provided for the
 * benefit of subclasses<br>
 * Added methods {@link #setSelectedFont(java.awt.Font)},
 * {@link #setSelectedFontFamily(String)}, {@link #setSelectedFontStyle(int)},
 * {@link #setSelectedFontSize(int)}<br>
 * GridBag fill strategy modified slightly to improve resizing behavior<br>
 * Changed sample code to use BorderLayout<br>
 * Added version history to javadocs
 * <dt><b>1.0</b> (August 15, 2000)
 * <dd>Initial release
 * </dl>
 * 
 * <p>
 * Copyright (C) 2000 Greg Merrill ( <a
 * href="mailto:greghmerrill@yahoo.com">greghmerrill@yahoo.com</a>). Distributed
 * under the terms of the GNU General Public License (version 2). For details on
 * the GNU GPL, please visit <a href="http://www.gnu.org/copyleft/gpl.html"
 * >http://www.gnu.org/copyleft/gpl.html</a>. To find out more about this and
 * other free software by Greg Merrill, please visit <a
 * href="http://gregmerrill.imagineis.com" >http://gregmerrill.imagineis.com</a>
 * 
...
public class FontSelectionPanel extends JPanel {
	...
	public FontSelectionPanel(Font initialFont, String[] styleDisplayNames,
		...
		addObserver(new Observer() {
			public void update(Observable o, Object arg) {
				try {
					phraseCanvas_.setPhrase((String) fontFamilyList_
							.getSelectedValue());
					phraseCanvas_.setFont(FontSelectionPanel.this
							.getSelectedFont());
	...
	public static class NoFontFamilySelectedException extends
	...
	public static class NoFontStyleSelectedException extends
			InvalidFontException {
	...
	public static class NoFontSizeSpecifiedException extends
			InvalidFontException {
    ...
    private static void createAndShowGUI() {
        ...
        FontSelectionPanel panel = new FontSelectionPanel();
