...
public class ConstructTests {
    ...
    //TODO why a constructor can't be final (or static, or abstract)?
    ...
    //Integer is immutable. its value, once set, can't be changed. A immutable's state cant be changed. If you look
    //into the source code, Integer's value is a final int. final meaning it can't be changed.

    //Interview with Credit Susie (01/23/14)
    //TODO How to return a non-primitive member in a class and make sure it’s NOT mutable?
    //TODO polymophism, how is it implemented in C++ or Java?
    //TODO Abstract class v.s Interface
    //TODO Inheritance v.s Composite
