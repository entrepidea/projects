...
public class PhoneNumber extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"PhoneNumber\",\"namespace\":\"com.entrepidea.avro.phonebook\",\"fields\":[{\"name\":\"areaCode\",\"type\":\"string\"},{\"name\":\"countryCode\",\"type\":\"string\",\"default\":\"\"},{\"name\":\"prefix\",\"type\":\"string\"},{\"name\":\"number\",\"type\":\"string\"}]}");
  ...
  public static com.entrepidea.avro.phonebook.PhoneNumber.Builder newBuilder() {
    return new com.entrepidea.avro.phonebook.PhoneNumber.Builder();
  }
  
  /** Creates a new PhoneNumber RecordBuilder by copying an existing Builder */
  public static com.entrepidea.avro.phonebook.PhoneNumber.Builder newBuilder(com.entrepidea.avro.phonebook.PhoneNumber.Builder other) {
    return new com.entrepidea.avro.phonebook.PhoneNumber.Builder(other);
  }
  
  /** Creates a new PhoneNumber RecordBuilder by copying an existing PhoneNumber instance */
  public static com.entrepidea.avro.phonebook.PhoneNumber.Builder newBuilder(com.entrepidea.avro.phonebook.PhoneNumber other) {
    return new com.entrepidea.avro.phonebook.PhoneNumber.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PhoneNumber>
    ...
    private Builder() {
      super(com.entrepidea.avro.phonebook.PhoneNumber.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.entrepidea.avro.phonebook.PhoneNumber.Builder other) {
      super(other);
    ...
    private Builder(com.entrepidea.avro.phonebook.PhoneNumber other) {
            super(com.entrepidea.avro.phonebook.PhoneNumber.SCHEMA$);
      if (isValidValue(fields()[0], other.areaCode)) {
        this.areaCode = data().deepCopy(fields()[0].schema(), other.areaCode);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'areaCode' field */
    public com.entrepidea.avro.phonebook.PhoneNumber.Builder setAreaCode(java.lang.CharSequence value) {
    ...
    public com.entrepidea.avro.phonebook.PhoneNumber.Builder clearAreaCode() {
      areaCode = null;
    ...
    /** Sets the value of the 'countryCode' field */
    public com.entrepidea.avro.phonebook.PhoneNumber.Builder setCountryCode(java.lang.CharSequence value) {
    ...
    public com.entrepidea.avro.phonebook.PhoneNumber.Builder clearCountryCode() {
      countryCode = null;
    ...
    /** Sets the value of the 'prefix' field */
    public com.entrepidea.avro.phonebook.PhoneNumber.Builder setPrefix(java.lang.CharSequence value) {
    ...
    public com.entrepidea.avro.phonebook.PhoneNumber.Builder clearPrefix() {
      prefix = null;
    ...
    /** Sets the value of the 'number' field */
    public com.entrepidea.avro.phonebook.PhoneNumber.Builder setNumber(java.lang.CharSequence value) {
    ...
    public com.entrepidea.avro.phonebook.PhoneNumber.Builder clearNumber() {
      number = null;
