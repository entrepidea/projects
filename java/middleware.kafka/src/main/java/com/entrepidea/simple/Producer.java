...
/**
* The code is from the book "Apache Kafka实战".
* Steps:
...
public class  Producer {
    public static void main(String[] args){
        ...
        for(int i=0;i<100;i++){
            producer.send(new ProducerRecord<>("coronavirus", Integer.toString(i),Integer.toString(i)));
        }
        producer.close();
