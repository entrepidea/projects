...
import com.entrepidea.spring.core.ioc.annotation.AnnotatedBean;
import com.entrepidea.spring.core.ioc.annotation.DummyService;
import com.entrepidea.spring.core.ioc.annotation.DummyServiceImpl;
...
public class SpringIOCAnnotationTestCases {
	 ...
	 */
	@Configuration
	@ComponentScan("com.entrepidea.spring.ioc")
	...
	public void testAnnotationConfiguration(){
		...
		Assert.assertEquals("john.",dummy.getName());
	}
