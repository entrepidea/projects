...
import com.entrepidea.spring.core.spel.HelloWorldParser;
import com.entrepidea.spring.core.spel.RootObjectParser;
import com.entrepidea.spring.core.spel.TypeConversion;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = { "/META-INF/spring/core-config-context.xml" })
public class SpringSpELTestCases {
	
	private static Logger LOGGER = LoggerFactory.getLogger(SpringSpELTestCases.class);
