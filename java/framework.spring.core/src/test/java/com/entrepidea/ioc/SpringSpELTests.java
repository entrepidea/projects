...
import com.entrepidea.spring.core.spel.supports.HelloWorldParser;
import com.entrepidea.spring.core.spel.supports.RootObjectParser;
import com.entrepidea.spring.core.spel.supports.TypeConversion;

@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = { "/config/META-INF/spring/core-config-context.xml" })
public class SpringSpELTests {
	
	private static Logger LOGGER = LoggerFactory.getLogger(SpringSpELTests.class);
