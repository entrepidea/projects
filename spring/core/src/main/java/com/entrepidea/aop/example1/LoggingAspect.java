...
public class LoggingAspect {
    ...
    @Around("execution(* com.entrepidea.aop.example1.EmployeeManagerImpl.*(..))")
    ...
    @Around("execution(* com.entrepidea.aop.example1.EmployeeManagerImpl.getEmployeeById(..))")
    ...
    @Around("execution(* com.entrepidea.aop.example1.EmployeeManagerImpl.createEmployee(..))")
